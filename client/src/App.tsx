...
import AdminSettingsNew from "@/pages/admin/settings-new";
...
import InvitePageNew from "@/pages/invite-new";
...
function Router() {
  return (
    <Switch>
      {/* Welcome Page - sempre carrega sem autenticação */}
      <Route path="/" component={WelcomePage} />
      <Route path="/welcome" component={WelcomePage} />
      <Route path="/welcome-simple" component={WelcomeSimplePage} />
      
      {/* Auth Routes - sempre carrega sem autenticação */}
      ...
      {/* Invitation Routes - sempre carrega sem autenticação */}
      <Route path="/convite/:code" component={(props) => <InvitePageNew {...props} />} />
      <Route path="/parceiro/:code" component={(props) => <InvitePageNew {...props} />} />
      <Route path="/invite" component={(props) => <InvitePageNew {...props} />} />
      <Route path="/convite" component={(props) => <InvitePageNew {...props} />} />
      ...
      <ProtectedRouteMobile path="/admin/users-management" component={AdminUsersManagement} userType="admin" title="Gerenciamento de Usuários" />
      ...
      <ProtectedRouteMobile path="/admin/platform-fees" component={lazy(() => import("@/pages/admin/platform-fees").then(m => ({ default: m.default })))} userType="admin" title="Taxas da Plataforma" />
      <ProtectedRouteMobile path="/admin/settings" component={AdminSettingsNew} userType="admin" title="Configurações" />
